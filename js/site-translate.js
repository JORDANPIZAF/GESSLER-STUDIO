...
const TRANSLATIONS = {
    en: {
        ...
        "Soy Jordan Piza, diseñador multimedia enfocado en estrategia, diseño visual y soluciones centradas en las personas para marcas en crecimiento.": "I'm Jordan Piza, a multimedia designer focused on strategy, visual design and people-centered solutions for growing brands.",
        ...
        "Gessler Studio es el estudio de Jordan Piza. Lidero el diseño multimedia, la comunicación visual y la ejecución de marca de principio a fin en cada proyecto.": "Gessler Studio is Jordan Piza's studio. I lead multimedia design, visual communication and brand execution from start to finish on every project.",
        "Esta página es el punto de entrada para conocerme mejor. Descubre cómo trabajo y qué hay detrás del estudio.": "This page is the starting point to get to know me better. Discover how I work and what's behind the studio.",
        ...
        "Un solo perfil": "One profile",
        "Conoce a la persona detrás de Gessler Studio": "Meet the person behind Gessler Studio",
        ...
        "Sobre el estudio": "About the studio",
        "Un estudio creativo construyendo marcas, visuales y comunicación con intención.": "A creative studio building brands, visuals and communication with intention.",
        "Gessler Studio es el espacio creativo de Jordan Piza. Combino diseño multimedia, dirección visual y pensamiento estratégico para crear trabajo que se sienta expresivo y bien estructurado.": "Gessler Studio is Jordan Piza's creative space. I combine multimedia design, visual direction and strategic thinking to create work that feels both expressive and well structured.",
        "Cada proyecto pasa por mis manos de principio a fin: estrategia, diseño y ejecución, sin intermediarios ni traducciones perdidas entre etapas.": "Every project goes through my hands from start to finish: strategy, design and execution, with no middlemen and nothing lost in translation between stages.",
